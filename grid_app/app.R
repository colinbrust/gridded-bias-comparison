    ...
    tabPanel("Elevation Plots",
             ...
             sidebarLayout(
               ...
               sidebarPanel(
                 ...
                 radioButtons("stat2", "Statistic:",
                              c("Normal" = "Normal",
                                "Standard Deviation" = "SD")),

                 selectInput("variable2", "Variable:", ""),

                 selectInput("cd", "Climate Division:",
                              c("Central" = "CENTRAL",
    ...
    tabPanel("Maps",
             ...
             sidebarLayout(
               ...
               sidebarPanel(
                 ...
                 selectInput("time3", "Temporal Scale:",
                             c("Annual" = "Annual",
                               "Seasonal" = "Seasonal",
                               "Monthly" = "Monthly")),
